...
def train_val(model_type,
    ...
    D_result_real = lyric_discriminator(real_lyric_latent_variable)
    # pdb.set_trace()
    D_real_loss = BCE_loss(D_result_real, y_real_)

    D_result_fake = lyric_discriminator(generated_lyric_latent_variable)
    ...
    # some problem here
    D_result_generate = lyric_discriminator(generated_lyric_latent_variable)
    generator_loss = BCE_loss(D_result_generate, y_real_)
...
if __name__=='__main__':
    ...
    lyric_discriminator = LyricDiscriminatorGAN(ldis_input_size)
